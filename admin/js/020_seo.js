jQuery(function($) {
    ...
    var $content = $('<div class="seo-preview">' +
        '<p class="seo-preview__label">SEO Snippet Preview</p>' +
        '<p class="seo-preview__title">' + metaTitle + '</p>' +
        '<p class="seo-preview__desc">' + metaDescription + '</p>' +
        '<a class="seo-preview__link" href="#wpseo_meta">edit</a>' +
        '</div>');
